...
if(isset($_GET['session'])){
    ...
    switch($oper){
        ...
        case 1:
            ...
            echo "<form action='sessionP.php?session=2' method='POST'>";
                echo "<a href='sessionP.php?session=3'>Read Value</a><br>";
        ...
        case 2:
            ...
            echo "<a href='sessionP.php'>Go Back</a>";
        break;
        ...
        case 3:
            ...
            echo "<form action='sessionP.php?session=2' method='POST'>";
                echo "<a href='sessionP.php'>Modify</a><br>";
        ...
        default:
        session_destroy ();
        echo "<form action='sessionP.php?session=1' method='POST'>";
